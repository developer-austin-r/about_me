    ...
    <section id="education" className="py-24 relative">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="relative mt-12">
          {/* Timeline Line */}
          <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-blue-500/50 via-purple-500/50 to-transparent -translate-x-1/2 hidden md:block" />
          <div className="absolute left-4 top-0 bottom-0 w-px bg-gradient-to-b from-blue-500/50 via-purple-500/50 to-transparent block md:hidden" />
          ...
          <div className="flex flex-col gap-12">
            {PORTFOLIO_DATA.education.map((edu, idx) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-4 md:left-1/2 w-10 h-10 -translate-x-1/2 rounded-full glass border border-blue-500/50 flex items-center justify-center z-10 bg-[#030014]">
